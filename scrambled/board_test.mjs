...
/* The future is shut. A number sent up from a browser is a number off a clock
   the player controls, so tomorrow must be refused however the clock is set. */
t("SABOTAGE: a board far in the future is refused",
