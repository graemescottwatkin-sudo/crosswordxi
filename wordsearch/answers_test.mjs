 ...
 */
import { onRequestGet, sealedNow } from "../functions/wordsearch/answers/[[path]].js";
...
t("the window is imported from _lib/daily.js, not restated", (() => {
  const src = fs.readFileSync("functions/wordsearch/answers/[[path]].js", "utf8");
...
t("and links the crossword's answers, because the two archives cross-reference",
  idxText.indexOf("/crossword/answers/") > -1);
